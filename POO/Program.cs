...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine("Buscar estudiante ingrese el nombre.");
        
        string ? nombreB = Console.ReadLine() ?? String.Empty;
        Persona ? nombreObtenido = personas.Find(persona => persona.Name.StartsWith(nombreB));
        Console.WriteLine($"Se encontro el estudiante: {nombreB}");
